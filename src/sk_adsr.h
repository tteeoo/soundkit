...
sk_adsr_config sk_adsr_config_init(ma_uint32 channels, ma_uint32 sample_rate, float attack_time, float decay_time, float sustain_time, float sustain_multiplier, float release_time);
